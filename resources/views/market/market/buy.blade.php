...
<div class="container px-2 mx-auto">
            ...
            <div class="px-2 flex justify-between w-full mt-2 sm:w-1/2 md:w-2/5">
              <div class="px-2 w-full">
                ...
                <div class="flex flex-justify-between">
                  <select class="w-full" data-placeholder="من" name="salaryFrom" id="salaryFrom">
                    <option>شيء</option>
                    <option>شيء </option>
                  </select>
                  <select class="w-full" data-placeholder="إلى" name="salaryTo" id="salaryTo">
    ...
    <div class="flex justify-center my-6 pagenation">
      <ul class="flex border border-grey">
        ...
        <li><a class="block text-white bg-blue px-3 py-2 color border-r border-grey-light hover:text-black" href="#">3</a></li>
    ...
    <div class="news flex flex-wrap flex-col justify-center items-center" style="margin: 90px 0">
      ...
      <form class="w-full max-w-sm my-8">
        <div class="flex flex-wrap items-center py-2 px-4"> 
          <input class="appearance-none border border-indigo-700 bg-transparent text-gray-700 mr-3 py-2 px-2 leading-tight flex-grow w-full  md:w-auto md:ml-2 focus:outline-none" type="text" placeholder="أدخل رقم الواتس" aria-label="whatsApp number"/>
