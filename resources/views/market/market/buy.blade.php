...
<div class="flex justify-center my-6 pagenation">
    ...
    <ul class="flex border border-grey">
        <li>
            <a class="block px-3 py-2 color hover:text-black " href="#">السابق</a>
        </li>
        <li>
            <a class="block border-r border-grey-light px-3 py-2 color  active hover:text-black" href="#">1</a>
        </li>
        <li>
            <a class="block border-r border-grey-light px-3 py-2 color hover:text-black" href="#">2</a>
        </li>
        <li>
            <a class="block text-white bg-blue px-3 py-2 color border-r border-grey-light hover:text-black" href="#">3</a>
        </li>
        <li>
            <a class="block px-3 py-2 color border-r border-grey hover:text-black" href="#">التالي</a>
        </li>
    </ul>
</div>
<!-- End Pagenation -->
