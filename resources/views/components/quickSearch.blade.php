            ...
            <form class="inputs flex px-2 flex-wrap" action="#" method="post">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3  my-2 px-2">
                    ...
                    <div data-wrapper="governorate">
                        <select class="w-full singleSelect" name="governorate" id="governorate">
                            <option>--اختر--</option>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3  my-2 px-2">
                    ...
                    <div data-wrapper="outfitType">
                        <select class="w-full singleSelect" name="outfitType" id="outfitType">
                            <option>--اختر--</option>
                            <option>لون</option>
                            <option>لون</option>
                            <option>لون</option>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3  my-2 px-2">
                    ...
                    <div data-wrapper="transmissionType">
                        <select class="w-full singleSelect" name="transmissionType" id="transmissionType">
                            <option>--اختر--</option>
                            <option>لون</option>
                            <option>لون</option>
                            <option>لون</option>
                ...
                <div class="px-2 flex justify-between w-full mt-2 sm:w-1/2 md:w-2/5">
                    <div class="px-2 w-full">
                        ...
                        <div class="flex flex-justify-between">
                            <select class="w-full singleSelect" data-placeholder="من" name="yearFrom" id="salaryFrom">
                                <option>شيء</option>
                                <option>شيء </option>
                            </select>
                            <select class="w-full singleSelect" data-placeholder="إلى" name="yearTo" id="salaryTo">
                                <option>شيء</option>
                                <option>شيء </option>
                            </select>
                        </div>
